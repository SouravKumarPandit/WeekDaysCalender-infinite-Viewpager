...
public class CLCalendarView extends ViewPager
{
    ...
    private void initAttrs(AttributeSet attrs)
    {
        ...
        selectBackColor = typedArray.getColor(R.styleable.CalenderView_selectBackColorCV, Color.BLUE);
        ...
        for (int i = 0; i < calenderItemViews.length; i++)
        {
            ...
            calenderItemView.setOnItemSelectListener(new CLCalendarItemView.OnItemSelectListener()
            {
                ...
                public void onSelectDate(Calendar calendar)
                {
                    ...
                    {
                        onItemSelectListener.onSelectDate(calendar);
    ...
    {
//        if (calenderItemViews[getCurrentItem()%3]==calenderItemViews[0])
//            setCurrentItem(getCurrentItem());
    ...
    public void setCurrentCalender(int comparePos, Calendar calender)
    {
        ...
        if (calenderItemViews[0].getOnItemSelectListener() != null)
            calenderItemViews[0].getOnItemSelectListener().onSelectDate(calender);
